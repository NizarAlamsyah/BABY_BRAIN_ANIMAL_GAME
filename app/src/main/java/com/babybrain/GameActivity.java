...
import com.babybrain.adapter.DatabaseAdapter;
import com.babybrain.adapter.RiwayatSkorAdapter;
import com.babybrain.data.RiwayatSkor;
import com.babybrain.data.SoalPg;
import com.babybrain.dialog.ExitDialog;
import com.babybrain.dialog.SkorDialog;

import java.util.List;

public class GameActivity extends AppCompatActivity {
    TextView tvSkor, tvNomorSoal, tvSoalku;
    ...
    private void initComponents() {
        ...
        tvSoalku = findViewById(R.id.tv_soalku);
    ...
    public void setKonten() {
        ...
        if (x >= arr) {
            ...
            tvSoalku.setText(soalPG.getSoalku(x));
