...
import com.babybrain.dialog.AboutDialog;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.btn_permainan) {
            ...
            visitSosmed("https://instagram.com/pti20aja?igshid=YmMyMTA2M2Y=");
        } else if (id == R.id.btn_twitter) {
            visitSosmed("https://twitter.com/sendokun1ty?t=H9Ms-e7Yl7QaYlLcGZ2asQ&s=08");
